...
namespace TimeSeriesDB.DataStreams.Writers
{
    ...
    public sealed class DataStreamWriter_Int64_LSB : DataStreamWriterWrapperBase_Complex<long, ulong>, IResumableDataStreamWriter {
        public DataStreamWriter_Int64_LSB() : base(new DataStreamWriter_UInt64_LSB(), sizeof(ulong)) { }
        ...
        public override Readers.IDataStreamReader CreateReader() {
            return new Readers.DataStreamReader_Int64_LSB();
        }
    }
}
