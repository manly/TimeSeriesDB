...
namespace TimeSeriesDB.DataStreams.Readers.WithDecoders
{
    ...
    #region public class Delta_DataStreamReader_UInt64_LSB
    public sealed class Delta_DataStreamReader_UInt64_LSB : DataStreamReaderWrapperBase<ulong> {
        private ulong m_prev = 0;

        public Delta_DataStreamReader_UInt64_LSB() : base(new DataStreamReader_UInt64_LSB()) { }
        ...
        private void InternalGetNext(ref ulong value) {
            value = Helper.DeltaAdd(m_prev, value);
            m_prev = value;
        }

        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_UInt64_LSB();
        }
    }
    #endregion
    #region public class Delta_DataStreamReader_UInt64
    public sealed class Delta_DataStreamReader_UInt64 : DataStreamReaderWrapperBase<ulong> {
        private ulong m_prev = 0;

        public Delta_DataStreamReader_UInt64() : base(new DataStreamReader_UInt64()) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_UInt64();
        }
    }
    #endregion
    #region public class Delta_DataStreamReader_UInt32
    public sealed class Delta_DataStreamReader_UInt32 : DataStreamReaderWrapperBase<uint> {
        private uint m_prev = 0;

        public Delta_DataStreamReader_UInt32() : base(new DataStreamReader_UInt32()) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_UInt32();
        }
    }
    #endregion
    #region public class Delta_DataStreamReader_UInt16
    public sealed class Delta_DataStreamReader_UInt16 : DataStreamReaderWrapperBase<ushort> {
        private ushort m_prev = 0;

        public Delta_DataStreamReader_UInt16() : base(new DataStreamReader_UInt16()) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_UInt16();
        }
    }
    #endregion
    #region public class Delta_DataStreamReader_UInt8
    public sealed class Delta_DataStreamReader_UInt8 : DataStreamReaderWrapperBase<byte> {
        private byte m_prev = 0;

        public Delta_DataStreamReader_UInt8() : base(new DataStreamReader_UInt8()) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_UInt8();
        }
    }
    #endregion

    #region public class Delta_DataStreamReader_Int64_LSB
    public sealed class Delta_DataStreamReader_Int64_LSB : DataStreamReaderWrapperBase<long> {
        private long m_prev = 0;

        public Delta_DataStreamReader_Int64_LSB() : base(new DataStreamReader_Int64_LSB()) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_Int64_LSB();
        }
    }
    #endregion
    #region public class Delta_DataStreamReader_Int64
    public sealed class Delta_DataStreamReader_Int64 : DataStreamReaderWrapperBase<long> {
        private long m_prev = 0;

        public Delta_DataStreamReader_Int64() : base(new DataStreamReader_Int64()) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_Int64();
        }
    }
    #endregion
    #region public class Delta_DataStreamReader_Int32
    public sealed class Delta_DataStreamReader_Int32 : DataStreamReaderWrapperBase<int> {
        private int m_prev = 0;

        public Delta_DataStreamReader_Int32() : base(new DataStreamReader_Int32()) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_Int32();
        }
    }
    #endregion
    #region public class Delta_DataStreamReader_Int16
    public sealed class Delta_DataStreamReader_Int16 : DataStreamReaderWrapperBase<short> {
        private short m_prev = 0;

        public Delta_DataStreamReader_Int16() : base(new DataStreamReader_Int16()) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_Int16();
        }
    }
    #endregion
    #region public class Delta_DataStreamReader_Int8
    public sealed class Delta_DataStreamReader_Int8 : DataStreamReaderWrapperBase<sbyte> {
        private sbyte m_prev = 0;

        public Delta_DataStreamReader_Int8() : base(new DataStreamReader_Int8()) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_Int8();
        }
    }
    #endregion

    #region public class Delta_DataStreamReader_DateTime
    public sealed class Delta_DataStreamReader_DateTime : DataStreamReaderWrapperBase_Complex<DateTime, ulong> {
        private ulong m_prev = 0;
        ...
        public Delta_DataStreamReader_DateTime() : base(new DataStreamReader_UInt64(), sizeof(ulong)) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_DateTime();
        }
    }
    #endregion
    #region public class Delta_DataStreamReader_TimeSpan
    public sealed class Delta_DataStreamReader_TimeSpan : DataStreamReaderWrapperBase_Complex<TimeSpan, ulong> {
        private ulong m_prev = 0;

        public Delta_DataStreamReader_TimeSpan() : base(new DataStreamReader_UInt64_LSB(), sizeof(ulong)) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.WithEncoders.Delta_DataStreamWriter_TimeSpan();
        }
    }
    #endregion
}
