...
namespace TimeSeriesDB.DataStreams.Readers
{
    ...
    public sealed class DataStreamReader_Int64 : DataStreamReaderWrapperBase_Complex<long, ulong> {
        public DataStreamReader_Int64() : base(new DataStreamReader_UInt64(), sizeof(ulong)) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.DataStreamWriter_Int64();
        }
    }
}
