...
namespace TimeSeriesDB.DataStreams.Readers
{
    ...
    public sealed class DataStreamReader_TimeSpan : DataStreamReaderWrapperBase_Complex<TimeSpan, ulong> {
        public DataStreamReader_TimeSpan() : base(new DataStreamReader_UInt64_LSB(), sizeof(ulong)) { }
        ...
        public override Writers.IDataStreamWriter CreateWriter() {
            return new Writers.DataStreamWriter_TimeSpan();
        }
    }
}
